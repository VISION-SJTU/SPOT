...
def run(settings):
    ...
    settings.description = 'SPOT: Sparsely-Supervised Object Tracking. Version: SP-TransT-2.'
    ...
    settings.magic_number = "spot_transt_002"
    ...
    settings.fs_settings = {'LaSOT': {'name': "LaSOT_train_kf_002",
                                      'split': "train", 'stage': ['burnin', 'sparse']},
                            'GOT-10k': {'name': "GOT-10k_vottrain_kf_002",
                                        'split': "vottrain", 'stage': ['burnin', 'sparse']},
                            'TrackingNet': {'name': "TrackingNet_0-3_kf_002",
    ...
    loader_datasets = {'train_datasets': [lasot_train, got10k_train, trackingnet_train],
                       'train_splits': [1, 1, 1]}
