...
def run_training(train_module, train_name, cudnn_benchmark=True):
    ...
    args:
        train_module - Name of module in the "ltr/train_settings/" folder.
...
def main():
    ...
    parser.add_argument('train_module', type=str, help='Name of module in the "ltr/train_settings/" folder.')
