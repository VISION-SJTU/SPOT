...
class ResNet50_Ocean(nn.Module):

    def __init__(self, used_layers=None):
        super(ResNet50_Ocean, self).__init__()
...
def build_backbone_ocean(settings):

    backbone = ResNet50_Ocean(used_layers=settings.used_layers)
