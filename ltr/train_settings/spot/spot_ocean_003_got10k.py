...
def run(settings):
    ...
    settings.description = 'SPOT: Sparsely-Supervised Object Tracking. Version: SP-Ocean-3-GOT.'
    ...
    settings.magic_number = "spot_ocean_003_got10k"
