...
def run(settings):
    ...
    settings.description = 'SPOT: Sparsely-Supervised Object Tracking. Version: SP-TransT-5.'
    ...
    settings.magic_number = "spot_transt_005"
    ...
    settings.fs_settings = {'LaSOT': {'name': "LaSOT_train_kf_005",
                                      'split': "train", 'stage': ['burnin', 'sparse']},
                            'GOT-10k': {'name': "GOT-10k_vottrain_kf_005",
                                        'split': "vottrain", 'stage': ['burnin', 'sparse']},
                            'TrackingNet': {'name': "TrackingNet_0-3_kf_005",
